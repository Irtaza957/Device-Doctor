<template>
  <div>
    <div v-if="!loadingIssues">
      <div v-if="issues">
        <Container>
          <BookingHeader :show-back-button="!isEdit" header-text="Select issues" :selection="canGoNext" @goBack="$emit('goBack')" @goNext="addToCart" />
...
export default {
  ...
  methods: {
    ...technicalSupportModule.mapActions(['FETCH_T_S_ISSUES']),

    async fetchIssues () {
      try {
        this.loadingIssues = true
        const resp = await this.FETCH_T_S_ISSUES()
